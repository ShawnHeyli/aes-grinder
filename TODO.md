- [] Enlever les variables linéaires. (If a variable x occurs only linearly, then it can be eliminated from all the equations except one by taking linear combinations of the equations.)
